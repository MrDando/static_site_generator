...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_image_extractor(self):
        ...
        expected_images = [("image", "https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/zjjcJKZ.png"), ("another", "https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/dfsdkjfd.png")]
        actual_images = extract_markdown_images(text)
        self.assertListEqual(expected_images, actual_images)
